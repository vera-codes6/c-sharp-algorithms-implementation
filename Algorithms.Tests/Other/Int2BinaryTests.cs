...
public static class Int2BinaryTests
{
    ...
    [TestCase(
        ...
        "0000000000000000000000000000000000000000000000000001010100111000"
    )]
    [TestCase(
        (ulong)0b1110111100110010,
        "0000000000000000000000000000000000000000000000001110111100110010"
    )]
    [TestCase(
        (ulong)0b10101100001110101110111100110010,
        "0000000000000000000000000000000010101100001110101110111100110010"
    )]
    [TestCase(
        0b1000101110100101000011010101110101010101110101001010000011111000,
