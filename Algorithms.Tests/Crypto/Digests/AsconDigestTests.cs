...
public class AsconDigestTests
{
    ...
    private readonly AsconDigest asconHashA = new AsconDigest(
        AsconDigest.AsconParameters.AsconHashA
    );
    ...
    [TestCase(
        "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
        "4ff71928d740524735b5ab12bb1598463054f88089f3c5f9760b6bdcd23f897b"
    )]
    [TestCase(
        "12345678901234567890123456789012345678901234567890123456789012345678901234567890",
        "2dae8b553b93841120e88ee77b9ccb8b512a32318db6012025f3f1c482b1def8"
    )]
    ...
    [TestCase(
        "abcdefghijklmnopqrstuvwxyz",
        "406b809260f361e12dcf0bf924bfe1ffd2f987fc18d90b94fc544ff80dc2946b"
    )]
    [TestCase(
        "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
        "5c6c69ff3ee83361391b7236c8eb6718f52df43de5a61a4f4d2819d40430dc19"
    )]
    [TestCase(
        "12345678901234567890123456789012345678901234567890123456789012345678901234567890",
    ...
    public void BlockUpdate_WithInvalidOffset_ShouldThrowDataLengthException()
    {
        ...
        // Assert
        act.Should().Throw<DataLengthException>().WithMessage("input buffer too short");
    }
